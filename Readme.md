...
# Parsing + Configuration Script – Copia - Rev. A

This **Parsing + Configuration** script is designed for the **Copia** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Copia Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Copia** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
